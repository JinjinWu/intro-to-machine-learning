...
def NNUpdate(model, eps, momentum):
    ...
    # Insert your code here.
    # Update the weights.
    model['v1'] = -eps * model['dE_dW1'] + momentum * model['v1']
    model['v2'] = -eps * model['dE_dW2'] + momentum * model['v2']
    model['v3'] = -eps * model['dE_dW3'] + momentum * model['v3']
    ...
    model['W1'] = model['W1'] + model['v1']
    model['W2'] = model['W2'] + model['v2']
    model['W3'] = model['W3'] + model['v3']
